...
let showReloadPromptOnce = false;
let showWaitForDownloadPromptOnce = false;
let showReloadPromptAlways = false;
function enableReloadOrWaitPrompt() {
    showReloadPromptOnce = showReloadPromptAlways = showWaitForDownloadPromptOnce = true;
}
exports.enableReloadOrWaitPrompt = enableReloadOrWaitPrompt;
function getShowReloadPromptOnce() { return showReloadPromptOnce; }
exports.getShowReloadPromptOnce = getShowReloadPromptOnce;
function getShowReloadPrompt() { return showReloadPromptAlways; }
exports.getShowReloadPrompt = getShowReloadPrompt;
function getShowWaitForDownloadPromptOnce() { return showWaitForDownloadPromptOnce; }
exports.getShowWaitForDownloadPromptOnce = getShowWaitForDownloadPromptOnce;
...
exports.showReloadPrompt = showReloadPrompt;
function showWaitForDownloadPrompt() {
...
exports.showWaitForDownloadPrompt = showWaitForDownloadPrompt;
function showReloadOrWaitPromptImpl(once) {
    checkInstallLockFile().then((installLockExists) => {
...
function showReloadOrWaitPrompt() { showReloadOrWaitPromptImpl(false); }
exports.showReloadOrWaitPrompt = showReloadOrWaitPrompt;
function showReloadOrWaitPromptOnce() { showReloadOrWaitPromptImpl(true); }
exports.showReloadOrWaitPromptOnce = showReloadOrWaitPromptOnce;
...
let reloadLater = false;
function setDebuggerReloadLater() { reloadLater = true; }
exports.setDebuggerReloadLater = setDebuggerReloadLater;
function getDebuggerReloadLater() { return reloadLater; }
exports.getDebuggerReloadLater = getDebuggerReloadLater;
...
function touchPackageLockFile() {
    return touchFile(getPackageLockPath());
}
exports.touchPackageLockFile = touchPackageLockFile;
